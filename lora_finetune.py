...
output_dir = "fine/tuneQwen7B_LCU_SFT"
batch_size = 2
...
model = AutoModelForCausalLM.from_pretrained(
    model_name,
    device_map="auto",
    torch_dtype="auto",  # 或 float16 / bf16，根据你显存
)
...
lora_config = LoraConfig(
    r=8,
    lora_alpha=16,
    target_modules = ["q_proj", "v_proj", "o_proj", "up_proj", "down_proj", "gate_proj"], # 根据 Qwen2-7B 层结构确认
    lora_dropout=0.05,
    bias="none",
    task_type="CAUSAL_LM",
)
...
# ======================================================
domain_files = {
    "staytime": "finetune/staytime_prediction.jsonl",
    "top_comment": "finetune/kuaiComt_top_comment_prediction_data.jsonl",
    "interaction": "finetune/user_comment_interaction_prediction.jsonl"
}
...
# ======================================================
alpaca = load_dataset("json", data_files="finetune/alpaca_data.json", split="train")
